...
public class Login extends AppCompatActivity {
    ...
    public void senResetPass(){
        ...
        if (email.isEmpty()){
            ...
            Toast.makeText(Login.this, "Isi Email Anda Pada Kolom Diatas", Toast.LENGTH_SHORT).show();
        }else {
